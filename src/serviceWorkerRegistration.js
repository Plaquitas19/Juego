...
// Este archivo asegura que el service worker se registre correctamente
const isLocalhost = Boolean(
  ...
  export function register(config) {
    if (process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {
      ...
      window.addEventListener('load', () => {
        ...
        if (isLocalhost) {
          // Esto activa el service worker localmente
          checkValidServiceWorker(swUrl, config);
  
          navigator.serviceWorker.ready.then(() => {
            console.log('Esta aplicación está funcionando en modo offline.');
          });
        } else {
  ...
  function checkValidServiceWorker(swUrl, config) {
    fetch(swUrl, {
      ...
      .catch(() => {
        console.log(
          'No se pudo conectar con el Service Worker. Ejecutando en modo offline.'
        );
      });
  }
